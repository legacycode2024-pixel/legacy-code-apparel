...
const faqs = [
  { question: 'What is your return policy?', answer: 'We accept returns within 30 days of purchase. Items must be unworn, unwashed and in original condition. To start a return email us at support@legacycodeapparel.store with your order number.' },
  ...
  { question: 'Can I exchange for a different size?', answer: 'Yes! Contact us at support@legacycodeapparel.store within 30 days and we will get you the right size.' },
    ...
    <main style={{ fontFamily: 'Georgia, serif', backgroundColor: '#FAFAFA', minHeight: '100vh', color: '#111' }}>
      ...
      <section style={{ maxWidth: '720px', margin: '0 auto', padding: '60px 20px' }}>
        ...
        <div style={{ marginTop: '48px', padding: '32px', backgroundColor: '#0a1931', borderRadius: '16px', textAlign: 'center' }}>
          ...
          <a href="mailto:support@legacycodeapparel.store" style={{ display: 'inline-block', padding: '14px 36px', border: '2px solid #c9a84c', color: '#c9a84c', textDecoration: 'none', fontSize: '13px', letterSpacing: '2px' }}>CONTACT US</a>
        </div>
      </section>
