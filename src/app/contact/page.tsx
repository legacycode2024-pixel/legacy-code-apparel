      ...
      <section style={{ maxWidth: '600px', margin: '0 auto', padding: '60px 20px' }}>
        {submitted ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <p style={{ textAlign: 'center', fontSize: '13px', color: '#666' }}>Call or text us: <a href="tel:4046207228" style={{ color: '#0a1931', fontWeight: '600' }}>(404) 620-7228</a><br /><br />Or email us directly at <a href="mailto:support@legacycodeapparel.store" style={{ color: '#0a1931', fontWeight: '600' }}>support@legacycodeapparel.store</a></p>
          </div>
        )}
      </section>
