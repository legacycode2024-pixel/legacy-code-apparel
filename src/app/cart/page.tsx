        ...
        {cart.length === 0 ? (
          ...
          <>
            ...
            <div style={{ marginTop: '32px', padding: '24px', backgroundColor: '#fff', borderRadius: '12px', border: '1px solid #e5e5e5' }}>
              ...
              <div style={{ backgroundColor: "#f4f1eb", border: "2px solid #c9a84c", borderRadius: "8px", padding: "16px", marginBottom: "16px", textAlign: "center" }}><p style={{ margin: "0 0 4px", fontWeight: "700", color: "#0a1931", fontSize: "15px" }}>Preorder Notice</p><p style={{ margin: 0, fontSize: "14px", color: "#444", lineHeight: "1.6" }}>This is a preorder. Your order ships by <strong>May 15, 2026</strong>. Standard shipping is 3-5 business days once we are fully stocked.</p></div><button onClick={handleCheckout} disabled={loading} style={{ width: '100%', padding: '16px', backgroundColor: loading ? '#666' : '#111', color: '#fff', border: 'none', borderRadius: '8px', cursor: loading ? 'not-allowed' : 'pointer', fontSize: '15px', fontWeight: '600', letterSpacing: '1px' }}>
