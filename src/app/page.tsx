...
const allProducts = [
  ...
  { id: 5, name: 'Word Is Bond', color: 'Black', price: 30, frontImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1775285019/word-black_jnwlli.jpg', backImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1775285019/wordback-white_exf98t.png' },
