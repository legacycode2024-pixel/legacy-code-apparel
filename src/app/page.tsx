...
const allProducts = [
  ...
  { id: 2, name: 'Actions Over Applause', color: 'Black', price: 30, frontImage: '/images/actions-front.png', backImage: '/images/actions-back-black.png' },
  ...
  { id: 6, name: "I Could've But I Didn't", color: 'Black', price: 30, frontImage: '/images/couldve-front.png', backImage: '/images/couldve-back-new.png' },
  ...
  { id: 8, name: 'Actions Over Applause', color: 'White', price: 30, frontImage: '/images/actions-front-white.png', backImage: '/images/actions-back-white.png' },
