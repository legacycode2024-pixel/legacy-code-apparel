...
const allProducts = [
  { id: 1, name: 'Stand On It', color: 'Black', price: 20, frontImage: '/images/standonit-back.png', backImage: '/images/standonit-front.png' },
  { id: 2, name: 'Actions Over Applause', color: 'Black', price: 20, frontImage: '/images/actions-front.png', backImage: '/images/actions-back.png' },
  ...
  { id: 5, name: 'Word Is Bond', color: 'Black', price: 20, frontImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1775286417/wordfont-black_pjuhdc.jpg', backImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1774846513/367BC533-7689-4E1A-B03D-AAF004F6FD69_eraib6.png' },
  { id: 6, name: "I Could've But I Didn't", color: 'Black', price: 20, frontImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1776662619/5AD469BE-328F-467D-9F46-D3E506C18096_u3cfcf.jpg', backImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1776664243/ChatGPT_Image_Apr_20_2026_at_01_47_01_AM_tfjzta.png' },
  { id: 7, name: 'Stand On It', color: 'White', price: 20, frontImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1774316977/standonit-whitefront_h6z7v9.jpg', backImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1774316976/standonit-whiteback_b5uq5t.jpg' },
  { id: 8, name: 'Actions Over Applause', color: 'White', price: 20, frontImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1774316611/actionsfront-white_jt4plp.jpg', backImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1774316939/actionsback-white_wrnfly.jpg' },
  ...
  { id: 11, name: 'Word Is Bond', color: 'White', price: 20, frontImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1774316977/wordfront-white_yucsqg.jpg', backImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1774845265/07A6183E-6913-42BA-9BAD-887A1D00DDD2_zu09ug.png' },
