...
const allProducts = [
  ...
  { id: 2, name: 'Actions Over Applause', color: 'Black', price: 20, frontImage: '/images/actions-front.png', backImage: '/images/actions-back-black.png' },
  ...
  { id: 4, name: 'Right Over Easy', color: 'Black', price: 20, frontImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1775328983/right-front_mjq0yp.jpg', backImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1775328406/rightovereasy-back-black_pk8wbu.jpg' },
  { id: 5, name: 'Word Is Bond', color: 'Black', price: 20, frontImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1775287137/wordfrontblack_jnjfig.jpg', backImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1775285019/wordback-black_cm2jl0.jpg' },
  { id: 6, name: "I Could've But I Didn't", color: 'Black', price: 20, frontImage: '/images/couldve-front.png', backImage: '/images/couldve-back-new.png' },
  ...
  { id: 8, name: 'Actions Over Applause', color: 'White', price: 20, frontImage: '/images/actions-front-white.png', backImage: '/images/actions-back-white.png' },
  ...
  { id: 10, name: 'Right Over Easy', color: 'White', price: 20, frontImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1774316976/rightfront-white_tblkun.jpg', backImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1774316977/rightovereasy-back-white_gvutt5.jpg' },
  ...
  { id: 12, name: "I Could've But I Didn't", color: 'White', price: 20, frontImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1774316939/couldvefront-white_mo8e22.jpg', backImage: 'https://res.cloudinary.com/dozyoetnr/image/upload/v1774316939/couldveback-white_g2e3g9.jpg' },
];
