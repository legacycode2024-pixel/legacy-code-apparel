...
const allProducts = [
  ...
  { id: 4, name: 'Right Over Easy', color: 'Black', price: 20, frontImage: '/images/right-front.png', backImage: '/images/right-back.png' },
  { id: 5, name: 'Word Is Bond', color: 'Black', price: 20, frontImage: '/images/word-front.png', backImage: '/images/word-back.png' },
  { id: 6, name: "I Could've But I Didn't", color: 'Black', price: 20, frontImage: '/images/couldve-front.png', backImage: '/images/couldve-back.png' },
